...
if (!file.exists(file.path(resultsdir, "mean_accuracies.npy")) & 
    !file.exists(file.path(resultsdir, "accuracies_time.npy"))) {
  ...
  print("Bayesian forager analysis results already exist, skipping analysis.")
}