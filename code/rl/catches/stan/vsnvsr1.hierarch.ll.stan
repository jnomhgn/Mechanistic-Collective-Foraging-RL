...
model {
  ...
  for (observation in 1 : OBSERVATIONS) {
    if (time[observation] == 0) {
      ...
      idalphaVSDR = inv_logit(logit_alphaVSDR + idoffset[id[observation], 5]);
...
generated quantities {
  ...
  array[ID] real<lower=0, upper=1> idalphaVSDR;
