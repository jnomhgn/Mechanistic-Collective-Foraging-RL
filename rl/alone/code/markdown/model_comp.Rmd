...
if(!dir.exists("asocial/results/modelcomp/diagnostics/detailed")){dir.create("asocial/results/modelcomp/diagnostics/detailed")}
```
...
if(!file.exists("asocial/results/modelcomp/modelcomp.Rdata")){
  ...
  for(mfit in 1:length(models$stan.loglik)){
    ...
    if(!dir.exists(
      paste("asocial/results/modelcomp/diagnostics/detailed",models$name[[mfit]] , sep = "/"))){
      dir.create(paste("asocial/results/modelcomp/diagnostics/detailed",models$name[[mfit]] , sep = "/"))
      }
    ...
    for (param in par.names) {
      ...
      ggsave(paste("asocial/results/modelcomp/diagnostics/detailed",models$name[[mfit]],  paste0("traceplot_", param, ".png"), sep = "/"), tplot)
    }
  ...
  # Save Variables
  save(list=c("results", "comparison", "winner"), file = paste("asocial/results/modelcomp", "modelcomp.Rdata", sep = "/"))
...
ggexport(p, width=1920, height=1080, 
       filename = paste("asocial", "results", "modelcomp","postpredict_alone.jpeg", sep="/"))
...
write.csv(plot.data, file = paste("asocial", "results", "modelcomp", "postpredict_acc_alone.csv", sep = "/"), row.names = F)
...
p
ggexport(p, width=1920, height=1080, 
       filename = paste("asocial", "results", "modelcomp","postpredict_acc_alone.jpeg", sep="/"))
