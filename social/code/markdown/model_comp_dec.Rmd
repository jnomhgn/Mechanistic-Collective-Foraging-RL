...
if(!file.exists(paste("social/results/modelcomp_dec/full_nonadaptive", "modelcomp_dec_full_nonadaptive.Rdata", sep = "/"))){
  ...
  # Save Variables
  save(results, comparison, comparison.named, winner, file = paste("social/results/modelcomp_dec/full_nonadaptive", "modelcomp_dec_full_nonadaptive.Rdata", sep = "/"))
  ...
  write.csv(x = comparison.named, file = paste("social/results/modelcomp_dec/full_nonadaptive", "modelcomp_dec_full_nonadaptive_named.csv", sep = "/"))
