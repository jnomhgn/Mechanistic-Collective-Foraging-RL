...
# Load fit
fit = readRDS(paste("social/results/modelcomp_decpayoff/full_nonadaptive", paste(winner, "fit", "rds", sep = "."), sep = "/"))
...
write.csv(plot.data, file = paste("social", "results", "modelcomp_decpayoff", "full_nonadaptive", "postpredict_catches.csv", sep = "/"))
...
ggexport(p, width=1920, height=1080, 
       filename = paste("social", "results", "modelcomp_decpayoff","full_nonadaptive","postpredict_catches.jpeg", sep = "/"))
...
plot.data.nocatch = read.csv(file = paste("social", "results", "modelcomp_dec", "full_nonadaptive", "postpredict_acc_nocatch.csv", sep = "/"))

plot.data = bind_rows(plot.data.nocatch, plot.data.catch)

write.csv(plot.data, file = paste("social", "results", "modelcomp_decpayoff", "full_nonadaptive", "postpredict_acc_catch.csv", sep = "/"), row.names = F)
...
p
ggexport(p, width=1920, height=1080, 
       filename = paste("social", "results", "modelcomp_decpayoff", "full_nonadaptive", "postpredict_acc_catches.jpeg", sep="/"))
